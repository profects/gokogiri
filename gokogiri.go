...
import (
	"github.com/profects/gokogiri/html"
...
found in the github.com/profects/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
